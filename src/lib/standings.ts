...
const NAME_MAP: Record<string, string> = {
  ...
  'Sport-Club Freiburg': 'Freiburg', 'VfL Wolfsburg': 'Wolfsburg', 'SV Werder Bremen': 'Werder Bremen',
  ...
  'RC Lens': 'Lens', 'RC Strasbourg Alsace': 'Strasbourg', 'FC Nantes': 'Nantes', 'Toulouse FC': 'Toulouse',
